...
def audit(root: Path) -> dict:
    ...
    b1_b7_cone01_shared_theta_independent_baseline_path = (
        results / "B1_B7_cone01_shared_theta_independent_baseline_gate_v0.json"
    )
    b1_b7_cone01_shared_theta_refreshed_b7_ledger_path = (
    ...
    b1_b7_cone01_shared_theta_independent_baseline_manifest = current_results.get(
        "b1_b7_cone01_shared_theta_independent_baseline_gate_v0"
    )
    b1_b7_cone01_shared_theta_refreshed_b7_ledger_manifest = current_results.get(
        "b1_b7_cone01_shared_theta_refreshed_b7_ledger_gate_v0"
    )
    ...
    b1_b7_cone01_shared_theta_synthesis_object = {
        "path": str(b1_b7_cone01_shared_theta_synthesis_object_path),
        "exists": b1_b7_cone01_shared_theta_synthesis_object_path.exists(),
    }
    if not b1_b7_cone01_shared_theta_synthesis_object_manifest:
        errors.append("B1 manifest missing current result: b1_b7_cone01_shared_theta_synthesis_object_gate_v0")
    else:
        if (
            b1_b7_cone01_shared_theta_synthesis_object_manifest.get("status")
            != "cone01_shared_theta_synthesis_object_proposal"
        ):
            errors.append("B1/B7 cone_01 shared-theta object gate must remain a proposal")
        for field in ["report", "markdown_report"]:
            value = b1_b7_cone01_shared_theta_synthesis_object_manifest.get(field)
            if not value or not path_exists_from(benchmarks, value):
                errors.append(f"B1/B7 cone_01 shared-theta object gate missing existing {field} path: {value}")
    if b1_b7_cone01_shared_theta_synthesis_object_path.exists():
        shared_payload = json.loads(read(b1_b7_cone01_shared_theta_synthesis_object_path))
        shared_summary = shared_payload.get("summary", {})
        shared_claims = shared_payload.get("claim_boundary", {})
        b1_b7_cone01_shared_theta_synthesis_object.update(
            {
                "status": shared_payload.get("status"),
                "model_status": shared_payload.get("model_status"),
                "method": shared_payload.get("method"),
                "workload": shared_payload.get("workload"),
                "candidate_window_count": shared_summary.get("candidate_window_count"),
                "shared_synthesis_object_count": shared_summary.get("shared_synthesis_object_count"),
                "distinct_theta_group_count": shared_summary.get("distinct_theta_group_count"),
                "covered_occurrence_count": shared_summary.get("covered_occurrence_count"),
                "duplicate_theta_occurrence_count": shared_summary.get("duplicate_theta_occurrence_count"),
                "optimistic_cache_proxy_t_reuse": shared_summary.get("optimistic_cache_proxy_t_reuse"),
                "target_proxy_t_ledger_reduction_for_gcm_h6_1_20": shared_summary.get(
                    "target_proxy_t_ledger_reduction_for_gcm_h6_1_20"
                ),
                "shared_object_existence_gate_passed": shared_summary.get("shared_object_existence_gate_passed"),
                "all_candidate_windows_covered": shared_summary.get("all_candidate_windows_covered"),
                "semantic_replay_verified_object_count": shared_summary.get("semantic_replay_verified_object_count"),
                "physical_layout_assigned_object_count": shared_summary.get("physical_layout_assigned_object_count"),
                "b7_ledger_accepted_object_count": shared_summary.get("b7_ledger_accepted_object_count"),
                "occurrence_ledger_removed_occurrences": shared_summary.get("occurrence_ledger_removed_occurrences"),
                "occurrence_ledger_proxy_t_reduction": shared_summary.get("occurrence_ledger_proxy_t_reduction"),
                "cost_model_accepted": shared_summary.get("cost_model_accepted"),
                "rewrite_claimed": shared_claims.get("rewrite_claimed"),
                "resource_saving_claimed": shared_claims.get("resource_saving_claimed"),
                "semantic_certificate_claimed": shared_claims.get("semantic_certificate_claimed"),
                "physical_resource_reduction_claimed": shared_claims.get("physical_resource_reduction_claimed"),
                "b7_ledger_improvement_claimed": shared_claims.get("b7_ledger_improvement_claimed"),
                "validation_error_count": shared_summary.get("validation_error_count"),
            }
        )
        if shared_payload.get("benchmark_id") != "B1":
            errors.append("B1/B7 cone_01 shared-theta object gate report must have benchmark_id B1")
        if shared_payload.get("method") != "b1_b7_cone01_shared_theta_synthesis_object_gate_v0":
            errors.append("B1/B7 cone_01 shared-theta object gate method mismatch")
        if shared_payload.get("status") != "cone01_shared_theta_synthesis_object_proposal":
            errors.append("B1/B7 cone_01 shared-theta object gate status mismatch")
        if (
            shared_payload.get("model_status")
            != "shared_theta_objects_exist_without_replay_or_resource_acceptance"
        ):
            errors.append("B1/B7 cone_01 shared-theta object gate model_status mismatch")
        for field in [
            "candidate_window_count",
            ...
            if shared_summary.get(field) != b1_b7_cone01_shared_theta_synthesis_object_manifest.get(field):
                errors.append(f"B1/B7 cone_01 shared-theta object gate {field} mismatch")
        if shared_summary.get("candidate_window_count") != 35:
            errors.append("B1/B7 cone_01 shared-theta object gate must cover 35 candidate windows")
        if shared_summary.get("shared_synthesis_object_count") != 4:
            errors.append("B1/B7 cone_01 shared-theta object gate must define 4 shared objects")
        if shared_summary.get("covered_occurrence_count") != 35:
            errors.append("B1/B7 cone_01 shared-theta object gate must cover 35 occurrences")
        if shared_summary.get("shared_object_existence_gate_passed") is not True:
            errors.append("B1/B7 cone_01 shared-theta object gate should pass object existence")
        if shared_summary.get("all_candidate_windows_covered") is not True:
            errors.append("B1/B7 cone_01 shared-theta object gate should cover all windows")
        for field in [
            "semantic_replay_verified_object_count",
            "physical_layout_assigned_object_count",
            "b7_ledger_accepted_object_count",
            ...
            if shared_summary.get(field) != 0:
                errors.append(f"B1/B7 cone_01 shared-theta object gate {field} must remain 0")
        for field in [
            "cost_model_accepted",
            "rewrite_claimed",
            "resource_saving_claimed",
            ...
            if shared_summary.get(field) is not False:
                errors.append(f"B1/B7 cone_01 shared-theta object gate summary must not claim {field}")
            if shared_claims.get(field) is not False:
                errors.append(f"B1/B7 cone_01 shared-theta object gate must not claim {field}")
        if shared_summary.get("validation_error_count") != 0:
            errors.append("B1/B7 cone_01 shared-theta object gate validation errors must remain zero")
    else:
        errors.append(
            f"missing B1/B7 cone_01 shared-theta object gate report: "
    ...
    b1_b7_cone01_shared_theta_layout_routing = {
        "path": str(b1_b7_cone01_shared_theta_layout_routing_path),
        "exists": b1_b7_cone01_shared_theta_layout_routing_path.exists(),
    }
    if not b1_b7_cone01_shared_theta_layout_routing_manifest:
        errors.append("B1 manifest missing current result: b1_b7_cone01_shared_theta_layout_routing_gate_v0")
    else:
        if (
            b1_b7_cone01_shared_theta_layout_routing_manifest.get("status")
            != "cone01_shared_theta_logical_layout_routing_scaffold"
        ):
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate must remain a logical scaffold")
        for field in ["report", "markdown_report"]:
            value = b1_b7_cone01_shared_theta_layout_routing_manifest.get(field)
            if not value or not path_exists_from(benchmarks, value):
                errors.append(f"B1/B7 cone_01 shared-theta layout/routing gate missing existing {field} path: {value}")
    if b1_b7_cone01_shared_theta_layout_routing_path.exists():
        layout_payload = json.loads(read(b1_b7_cone01_shared_theta_layout_routing_path))
        layout_summary = layout_payload.get("summary", {})
        layout_claims = layout_payload.get("claim_boundary", {})
        b1_b7_cone01_shared_theta_layout_routing.update(
            {
                "status": layout_payload.get("status"),
                "model_status": layout_payload.get("model_status"),
                "method": layout_payload.get("method"),
                "workload": layout_payload.get("workload"),
                "candidate_window_count": layout_summary.get("candidate_window_count"),
                "shared_synthesis_object_count": layout_summary.get("shared_synthesis_object_count"),
                "replay_verified_object_count": layout_summary.get("replay_verified_object_count"),
                "replayed_occurrence_count": layout_summary.get("replayed_occurrence_count"),
                "layout_routed_object_count": layout_summary.get("layout_routed_object_count"),
                "layout_routed_occurrence_count": layout_summary.get("layout_routed_occurrence_count"),
                "logical_anchor_object_count": layout_summary.get("logical_anchor_object_count"),
                "logical_route_packet_count": layout_summary.get("logical_route_packet_count"),
                "logical_line_topology_qubit_count": layout_summary.get("logical_line_topology_qubit_count"),
                "total_logical_hop_count": layout_summary.get("total_logical_hop_count"),
                "max_logical_hop_count": layout_summary.get("max_logical_hop_count"),
                "missing_route_count": layout_summary.get("missing_route_count"),
                "layout_routing_gate_passed": layout_summary.get("layout_routing_gate_passed"),
                "physical_layout_claimed": layout_summary.get("physical_layout_claimed"),
                "factory_amortization_model_present": layout_summary.get("factory_amortization_model_present"),
                "shared_error_budget_present": layout_summary.get("shared_error_budget_present"),
                "semantic_rewrite_verified": layout_summary.get("semantic_rewrite_verified"),
                "semantic_certificate_claimed": layout_summary.get("semantic_certificate_claimed"),
                "occurrence_ledger_removed_occurrences": layout_summary.get("occurrence_ledger_removed_occurrences"),
                "occurrence_ledger_proxy_t_reduction": layout_summary.get("occurrence_ledger_proxy_t_reduction"),
                "cost_model_accepted": layout_summary.get("cost_model_accepted"),
                "rewrite_claimed": layout_claims.get("rewrite_claimed"),
                "resource_saving_claimed": layout_claims.get("resource_saving_claimed"),
                "physical_resource_reduction_claimed": layout_claims.get("physical_resource_reduction_claimed"),
                "b7_ledger_improvement_claimed": layout_claims.get("b7_ledger_improvement_claimed"),
                "validation_error_count": layout_summary.get("validation_error_count"),
            }
        )
        if layout_payload.get("benchmark_id") != "B1":
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate report must have benchmark_id B1")
        if layout_payload.get("method") != "b1_b7_cone01_shared_theta_layout_routing_gate_v0":
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate method mismatch")
        if layout_payload.get("status") != "cone01_shared_theta_logical_layout_routing_scaffold":
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate status mismatch")
        if layout_payload.get("model_status") != "logical_layout_routing_scaffold_not_physical_layout":
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate model_status mismatch")
        for field in [
            "candidate_window_count",
            "shared_synthesis_object_count",
            "replay_verified_object_count",
            "replayed_occurrence_count",
            "layout_routed_object_count",
            "layout_routed_occurrence_count",
            "logical_anchor_object_count",
            "logical_route_packet_count",
            "logical_line_topology_qubit_count",
            "total_logical_hop_count",
            "max_logical_hop_count",
            "missing_route_count",
            "layout_routing_gate_passed",
            ...
            if layout_summary.get(field) != b1_b7_cone01_shared_theta_layout_routing_manifest.get(field):
                errors.append(f"B1/B7 cone_01 shared-theta layout/routing gate {field} mismatch")
        if layout_summary.get("candidate_window_count") != 35:
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate must cover 35 candidate windows")
        if layout_summary.get("shared_synthesis_object_count") != 4:
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate must see 4 shared objects")
        if layout_summary.get("layout_routed_object_count") != 4:
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate must route 4 objects")
        if layout_summary.get("layout_routed_occurrence_count") != 35:
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate must route 35 occurrences")
        if layout_summary.get("logical_route_packet_count") != 35:
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate must emit 35 route packets")
        if layout_summary.get("total_logical_hop_count") != 139:
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate total hop count must be 139")
        if layout_summary.get("max_logical_hop_count") != 11:
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate max hop count must be 11")
        if layout_summary.get("missing_route_count") != 0:
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate missing routes must remain zero")
        if layout_summary.get("layout_routing_gate_passed") is not True:
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate should pass")
        for field in [
            "physical_layout_claimed",
            "factory_amortization_model_present",
            "shared_error_budget_present",
            ...
            if layout_summary.get(field) is not False:
                errors.append(f"B1/B7 cone_01 shared-theta layout/routing gate summary must not claim {field}")
            if field in layout_claims and layout_claims.get(field) is not False:
                errors.append(f"B1/B7 cone_01 shared-theta layout/routing gate must not claim {field}")
        for field in ["occurrence_ledger_removed_occurrences", "occurrence_ledger_proxy_t_reduction"]:
            if layout_summary.get(field) != 0:
                errors.append(f"B1/B7 cone_01 shared-theta layout/routing gate {field} must remain 0")
        if layout_summary.get("validation_error_count") != 0:
            errors.append("B1/B7 cone_01 shared-theta layout/routing gate validation errors must remain zero")
    else:
        errors.append(
            f"missing B1/B7 cone_01 shared-theta layout/routing gate report: "
    ...
    b1_b7_cone01_shared_theta_independent_baseline = {
        "path": str(b1_b7_cone01_shared_theta_independent_baseline_path),
        "exists": b1_b7_cone01_shared_theta_independent_baseline_path.exists(),
    }
    if not b1_b7_cone01_shared_theta_independent_baseline_manifest:
        errors.append("B1 manifest missing current result: b1_b7_cone01_shared_theta_independent_baseline_gate_v0")
    else:
        if (
            b1_b7_cone01_shared_theta_independent_baseline_manifest.get("status")
            != "cone01_shared_theta_independent_baseline_scaffold"
        ):
            errors.append("B1/B7 cone_01 shared-theta independent-baseline gate must remain a scaffold")
        for field in ["report", "markdown_report"]:
            value = b1_b7_cone01_shared_theta_independent_baseline_manifest.get(field)
            if not value or not path_exists_from(benchmarks, value):
                errors.append(
                    f"B1/B7 cone_01 shared-theta independent-baseline gate missing existing {field} path: {value}"
                )
    if b1_b7_cone01_shared_theta_independent_baseline_path.exists():
        baseline_payload = json.loads(read(b1_b7_cone01_shared_theta_independent_baseline_path))
        baseline_summary = baseline_payload.get("summary", {})
        baseline_claims = baseline_payload.get("claim_boundary", {})
        b1_b7_cone01_shared_theta_independent_baseline.update(
            {
                "status": baseline_payload.get("status"),
                "model_status": baseline_payload.get("model_status"),
                "method": baseline_payload.get("method"),
                "workload": baseline_payload.get("workload"),
                "candidate_window_count": baseline_summary.get("candidate_window_count"),
                "shared_synthesis_object_count": baseline_summary.get("shared_synthesis_object_count"),
                "distinct_theta_group_count": baseline_summary.get("distinct_theta_group_count"),
                "duplicate_theta_occurrence_count": baseline_summary.get("duplicate_theta_occurrence_count"),
                "baseline_occurrence_count": baseline_summary.get("baseline_occurrence_count"),
                "shared_object_count": baseline_summary.get("shared_object_count"),
                "baseline_proxy_t_pressure": baseline_summary.get("baseline_proxy_t_pressure"),
                "shared_object_proxy_t_pressure": baseline_summary.get("shared_object_proxy_t_pressure"),
                "gross_proxy_t_pressure_delta": baseline_summary.get("gross_proxy_t_pressure_delta"),
                "occurrence_ledger_removed_occurrences": baseline_summary.get(
                    "occurrence_ledger_removed_occurrences"
                ),
                "occurrence_ledger_proxy_t_reduction": baseline_summary.get("occurrence_ledger_proxy_t_reduction"),
                "double_counted_occurrence_count": baseline_summary.get("double_counted_occurrence_count"),
                "double_counted_proxy_t_pressure": baseline_summary.get("double_counted_proxy_t_pressure"),
                "cache_label_count": baseline_summary.get("cache_label_count"),
                "independent_baseline_gate_passed": baseline_summary.get("independent_baseline_gate_passed"),
                "independent_baseline_present": baseline_summary.get("independent_baseline_present"),
                "independent_physical_baseline_present": baseline_summary.get(
                    "independent_physical_baseline_present"
                ),
                "device_calibrated_baseline_present": baseline_summary.get(
                    "device_calibrated_baseline_present"
                ),
                "refreshed_b7_ledger_present": baseline_summary.get("refreshed_b7_ledger_present"),
                "cost_model_accepted": baseline_summary.get("cost_model_accepted"),
                "rewrite_claimed": baseline_claims.get("rewrite_claimed"),
                "resource_saving_claimed": baseline_claims.get("resource_saving_claimed"),
                "semantic_certificate_claimed": baseline_claims.get("semantic_certificate_claimed"),
                "physical_resource_reduction_claimed": baseline_claims.get("physical_resource_reduction_claimed"),
                "b7_ledger_improvement_claimed": baseline_claims.get("b7_ledger_improvement_claimed"),
                "validation_error_count": baseline_summary.get("validation_error_count"),
            }
        )
        if baseline_payload.get("benchmark_id") != "B1":
            errors.append("B1/B7 cone_01 shared-theta independent-baseline gate report must have benchmark_id B1")
        if baseline_payload.get("method") != "b1_b7_cone01_shared_theta_independent_baseline_gate_v0":
            errors.append("B1/B7 cone_01 shared-theta independent-baseline gate method mismatch")
        if baseline_payload.get("status") != "cone01_shared_theta_independent_baseline_scaffold":
            errors.append("B1/B7 cone_01 shared-theta independent-baseline gate status mismatch")
        if baseline_payload.get("model_status") != "independent_baseline_scaffold_not_physical_cost_model":
            errors.append("B1/B7 cone_01 shared-theta independent-baseline gate model_status mismatch")
        for field in [
            "candidate_window_count",
            "shared_synthesis_object_count",
            "distinct_theta_group_count",
            ...
            "occurrence_ledger_removed_occurrences",
            "occurrence_ledger_proxy_t_reduction",
            "double_counted_occurrence_count",
            "double_counted_proxy_t_pressure",
            "cache_label_count",
            ...
            if baseline_summary.get(field) != b1_b7_cone01_shared_theta_independent_baseline_manifest.get(field):
                errors.append(f"B1/B7 cone_01 shared-theta independent-baseline gate {field} mismatch")
        ...
        for field, value in expected_baseline_values.items():
            if baseline_summary.get(field) != value:
                errors.append(f"B1/B7 cone_01 shared-theta independent-baseline gate {field} must be {value}")
        if baseline_summary.get("independent_baseline_gate_passed") is not True:
            errors.append("B1/B7 cone_01 shared-theta independent-baseline gate should pass")
        if baseline_summary.get("independent_baseline_present") is not True:
            errors.append("B1/B7 cone_01 shared-theta independent-baseline should be present")
        for field in [
            "independent_physical_baseline_present",
            "device_calibrated_baseline_present",
            "refreshed_b7_ledger_present",
            ...
            if baseline_summary.get(field) is not False:
                errors.append(f"B1/B7 cone_01 shared-theta independent-baseline gate summary must not claim {field}")
            if field in baseline_claims and baseline_claims.get(field) is not False:
                errors.append(f"B1/B7 cone_01 shared-theta independent-baseline gate must not claim {field}")
        if baseline_summary.get("validation_error_count") != 0:
            errors.append("B1/B7 cone_01 shared-theta independent-baseline gate validation errors must remain zero")
    else:
        errors.append(
            f"missing B1/B7 cone_01 shared-theta independent-baseline gate report: "
            f"{b1_b7_cone01_shared_theta_independent_baseline_path}"
        )

    b1_b7_cone01_shared_theta_refreshed_b7_ledger = {
        "path": str(b1_b7_cone01_shared_theta_refreshed_b7_ledger_path),
        "exists": b1_b7_cone01_shared_theta_refreshed_b7_ledger_path.exists(),
    }
    if not b1_b7_cone01_shared_theta_refreshed_b7_ledger_manifest:
        errors.append("B1 manifest missing current result: b1_b7_cone01_shared_theta_refreshed_b7_ledger_gate_v0")
    else:
        if (
            b1_b7_cone01_shared_theta_refreshed_b7_ledger_manifest.get("status")
            != "cone01_shared_theta_refreshed_b7_ledger_rejected"
        ):
            errors.append("B1/B7 cone_01 shared-theta refreshed-B7-ledger gate must remain rejected")
        for field in ["report", "markdown_report"]:
            value = b1_b7_cone01_shared_theta_refreshed_b7_ledger_manifest.get(field)
            if not value or not path_exists_from(benchmarks, value):
                errors.append(
                    f"B1/B7 cone_01 shared-theta refreshed-B7-ledger gate missing existing {field} path: {value}"
                )
    if b1_b7_cone01_shared_theta_refreshed_b7_ledger_path.exists():
        refreshed_payload = json.loads(read(b1_b7_cone01_shared_theta_refreshed_b7_ledger_path))
        refreshed_summary = refreshed_payload.get("summary", {})
        refreshed_claims = refreshed_payload.get("claim_boundary", {})
        b1_b7_cone01_shared_theta_refreshed_b7_ledger.update(
            {
                "status": refreshed_payload.get("status"),
                "model_status": refreshed_payload.get("model_status"),
                "method": refreshed_payload.get("method"),
                "workload": refreshed_payload.get("workload"),
                "b7_ledger_refresh_attempted": refreshed_summary.get("b7_ledger_refresh_attempted"),
                "b7_ledger_accepts_theta_sharing": refreshed_summary.get("b7_ledger_accepts_theta_sharing"),
                "cost_model_accepted": refreshed_summary.get("cost_model_accepted"),
                "cost_model_acceptance_pass_count": refreshed_summary.get("cost_model_acceptance_pass_count"),
                "cost_model_acceptance_fail_count": refreshed_summary.get("cost_model_acceptance_fail_count"),
                "cm08_refreshed_b7_ledger_gate_passed": refreshed_summary.get(
                    "cm08_refreshed_b7_ledger_gate_passed"
                ),
                "candidate_window_count": refreshed_summary.get("candidate_window_count"),
                "distinct_theta_group_count": refreshed_summary.get("distinct_theta_group_count"),
                "optimistic_cache_proxy_t_reuse": refreshed_summary.get("optimistic_cache_proxy_t_reuse"),
                "occurrence_ledger_removed_occurrences": refreshed_summary.get(
                    "occurrence_ledger_removed_occurrences"
                ),
                "occurrence_ledger_proxy_t_reduction": refreshed_summary.get("occurrence_ledger_proxy_t_reduction"),
                "b7_ledger_proxy_t_reduction_before_refresh": refreshed_summary.get(
                    "b7_ledger_proxy_t_reduction_before_refresh"
                ),
                "b7_ledger_proxy_t_reduction_after_refresh": refreshed_summary.get(
                    "b7_ledger_proxy_t_reduction_after_refresh"
                ),
                "target_proxy_t_ledger_reduction_for_gcm_h6_1_20": refreshed_summary.get(
                    "target_proxy_t_ledger_reduction_for_gcm_h6_1_20"
                ),
                "missing_proxy_t_ledger_reduction_for_gcm_h6_1_20": refreshed_summary.get(
                    "missing_proxy_t_ledger_reduction_for_gcm_h6_1_20"
                ),
                "gcm_h6_current_total_t_ledger": refreshed_summary.get("gcm_h6_current_total_t_ledger"),
                "gcm_h6_target_max_after_t_ledger_1_20": refreshed_summary.get(
                    "gcm_h6_target_max_after_t_ledger_1_20"
                ),
                "gcm_h6_additional_t_ledger_to_remove_for_1_20": refreshed_summary.get(
                    "gcm_h6_additional_t_ledger_to_remove_for_1_20"
                ),
                "gcm_h6_min_row_improved": refreshed_summary.get("gcm_h6_min_row_improved"),
                "current_min_space_time_volume_reduction": refreshed_summary.get(
                    "current_min_space_time_volume_reduction"
                ),
                "refreshed_min_space_time_volume_reduction": refreshed_summary.get(
                    "refreshed_min_space_time_volume_reduction"
                ),
                "physical_device_layout_present": refreshed_summary.get("physical_device_layout_present"),
                "physical_factory_schedule_present": refreshed_summary.get("physical_factory_schedule_present"),
                "device_calibrated_validation_present": refreshed_summary.get(
                    "device_calibrated_validation_present"
                ),
                "rewrite_claimed": refreshed_claims.get("rewrite_claimed"),
                "resource_saving_claimed": refreshed_claims.get("resource_saving_claimed"),
                "semantic_certificate_claimed": refreshed_claims.get("semantic_certificate_claimed"),
                "physical_resource_reduction_claimed": refreshed_claims.get("physical_resource_reduction_claimed"),
                "b7_ledger_improvement_claimed": refreshed_claims.get("b7_ledger_improvement_claimed"),
                "validation_error_count": refreshed_summary.get("validation_error_count"),
            }
        )
        if refreshed_payload.get("benchmark_id") != "B1":
            errors.append("B1/B7 cone_01 refreshed-B7-ledger gate report must have benchmark_id B1")
        if refreshed_payload.get("method") != "b1_b7_cone01_shared_theta_refreshed_b7_ledger_gate_v0":
            errors.append("B1/B7 cone_01 refreshed-B7-ledger gate method mismatch")
        if refreshed_payload.get("status") != "cone01_shared_theta_refreshed_b7_ledger_rejected":
            errors.append("B1/B7 cone_01 refreshed-B7-ledger gate status mismatch")
        if (
            refreshed_payload.get("model_status")
            != "refreshed_b7_ledger_rejects_unaccepted_theta_sharing_model"
        ):
            errors.append("B1/B7 cone_01 refreshed-B7-ledger gate model_status mismatch")
        for field in [
            "b7_ledger_refresh_attempted",
            ...
            "target_proxy_t_ledger_reduction_for_gcm_h6_1_20",
            "missing_proxy_t_ledger_reduction_for_gcm_h6_1_20",
            "gcm_h6_current_total_t_ledger",
            "gcm_h6_target_max_after_t_ledger_1_20",
            "gcm_h6_additional_t_ledger_to_remove_for_1_20",
            "gcm_h6_min_row_improved",
            "current_min_space_time_volume_reduction",
            "refreshed_min_space_time_volume_reduction",
            ...
            if refreshed_summary.get(field) != b1_b7_cone01_shared_theta_refreshed_b7_ledger_manifest.get(field):
                errors.append(f"B1/B7 cone_01 refreshed-B7-ledger gate {field} mismatch")
        if refreshed_summary.get("b7_ledger_refresh_attempted") is not True:
            errors.append("B1/B7 cone_01 refreshed-B7-ledger attempt must be explicit")
        if refreshed_summary.get("b7_ledger_accepts_theta_sharing") is not False:
            errors.append("B1/B7 cone_01 refreshed-B7 ledger must reject theta sharing")
        if refreshed_summary.get("cost_model_accepted") is not False:
            errors.append("B1/B7 cone_01 refreshed-B7 ledger must see unaccepted cost model")
        if refreshed_summary.get("cm08_refreshed_b7_ledger_gate_passed") is not False:
            errors.append("B1/B7 cone_01 refreshed-B7 ledger CM-08 must remain failed")
        if refreshed_summary.get("b7_ledger_proxy_t_reduction_after_refresh") != 0:
            errors.append("B1/B7 cone_01 refreshed-B7 ledger reduction must remain 0")
        if refreshed_summary.get("gcm_h6_min_row_improved") is not False:
            errors.append("B1/B7 cone_01 refreshed-B7 ledger must not improve gcm_h6 min row")
        for field in [
            "rewrite_claimed",
            "resource_saving_claimed",
            "semantic_certificate_claimed",
            ...
            if refreshed_claims.get(field) is not False:
                errors.append(f"B1/B7 cone_01 refreshed-B7-ledger gate must not claim {field}")
        if refreshed_summary.get("validation_error_count") != 0:
            errors.append("B1/B7 cone_01 refreshed-B7-ledger gate validation errors must remain zero")
    else:
        errors.append(
            f"missing B1/B7 cone_01 shared-theta refreshed-B7-ledger gate report: "
            f"{b1_b7_cone01_shared_theta_refreshed_b7_ledger_path}"
        )
    ...
    if b1_b7_cone01_theta_sharing_cost_model_path.exists():
        ...
        b1_b7_cone01_theta_sharing_cost_model.update(
            {
                ...
                "shared_theta_layout_routing_gate_passed": cost_summary.get(
                    "shared_theta_layout_routing_gate_passed"
                ),
                "shared_theta_layout_routed_object_count": cost_summary.get(
                    "shared_theta_layout_routed_object_count"
                ),
                "shared_theta_layout_routed_occurrence_count": cost_summary.get(
                    "shared_theta_layout_routed_occurrence_count"
                ),
                "shared_theta_layout_total_logical_hop_count": cost_summary.get(
                ...
                "shared_theta_independent_baseline_gate_passed": cost_summary.get(
                    "shared_theta_independent_baseline_gate_passed"
                ),
                "shared_theta_independent_baseline_present": cost_summary.get(
                    "shared_theta_independent_baseline_present"
                ),
                "shared_theta_double_counted_occurrence_count": cost_summary.get(
                    "shared_theta_double_counted_occurrence_count"
                ),
                "shared_theta_double_counted_proxy_t_pressure": cost_summary.get(
                    "shared_theta_double_counted_proxy_t_pressure"
                ),
                "shared_theta_independent_baseline_gross_proxy_t_delta": cost_summary.get(
                    "shared_theta_independent_baseline_gross_proxy_t_delta"
                ),
                "shared_theta_refreshed_b7_ledger_gate_passed": cost_summary.get(
                    "shared_theta_refreshed_b7_ledger_gate_passed"
                ),
                "shared_theta_b7_ledger_refresh_attempted": cost_summary.get(
                    "shared_theta_b7_ledger_refresh_attempted"
                ),
                "shared_theta_b7_ledger_accepts_theta_sharing": cost_summary.get(
                    "shared_theta_b7_ledger_accepts_theta_sharing"
                ),
                "shared_theta_b7_ledger_proxy_t_reduction_after_refresh": cost_summary.get(
                    "shared_theta_b7_ledger_proxy_t_reduction_after_refresh"
                ),
                "shared_theta_gcm_h6_min_row_improved": cost_summary.get(
        ...
        if cost_payload.get("model_status") != "physical_theta_sharing_cost_model_requirements_refreshed_ledger_rejected":
        ...
        if cost_summary.get("shared_synthesis_object_count") != 4:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate must see 4 shared objects")
        if cost_summary.get("shared_object_existence_gate_passed") is not True:
        ...
        if cost_summary.get("shared_theta_layout_routing_gate_passed") is not True:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate CM-04 layout evidence must pass")
        if cost_summary.get("shared_theta_layout_routed_object_count") != 4:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate must see 4 layout-routed objects")
        if cost_summary.get("shared_theta_layout_routed_occurrence_count") != 35:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate must see 35 layout-routed occurrences")
        if cost_summary.get("shared_theta_layout_total_logical_hop_count") != 139:
        ...
        if cost_summary.get("shared_theta_independent_baseline_gate_passed") is not True:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate CM-07 baseline evidence must pass")
        if cost_summary.get("shared_theta_independent_baseline_present") is not True:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate must see independent-baseline evidence")
        if cost_summary.get("shared_theta_double_counted_occurrence_count") != 0:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate double-counted occurrences must remain 0")
        if cost_summary.get("shared_theta_double_counted_proxy_t_pressure") != 0:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate double-counted proxy-T pressure must remain 0")
        if cost_summary.get("shared_theta_independent_baseline_gross_proxy_t_delta") != 620:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate must see independent-baseline gross delta 620")
        if cost_summary.get("shared_theta_b7_ledger_refresh_attempted") is not True:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate must include refreshed-B7-ledger attempt")
        if cost_summary.get("shared_theta_refreshed_b7_ledger_gate_passed") is not False:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate CM-08 must remain failed")
        if cost_summary.get("shared_theta_b7_ledger_accepts_theta_sharing") is not False:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate B7 ledger must reject theta sharing")
        if cost_summary.get("shared_theta_b7_ledger_proxy_t_reduction_after_refresh") != 0:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate refreshed B7 reduction must remain 0")
        if cost_summary.get("shared_theta_gcm_h6_min_row_improved") is not False:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate gcm_h6 min row must remain unimproved")
        if cost_summary.get("cost_model_acceptance_pass_count") != 6:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate pass count must now be 6")
        if cost_summary.get("cost_model_acceptance_fail_count") != 2:
            errors.append("B1/B7 cone_01 theta-sharing cost-model gate fail count must now be 2")
    ...
    return {
        ...
        "status_artifacts": {
            ...
            "b1_b7_cone01_shared_theta_independent_baseline_gate": str(
                b1_b7_cone01_shared_theta_independent_baseline_path
            ),
            "b1_b7_cone01_shared_theta_refreshed_b7_ledger_gate": str(
                b1_b7_cone01_shared_theta_refreshed_b7_ledger_path
            ),
...
def markdown_report(report: dict) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            f"- Exists: {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('exists')}",
            f"- Status: {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('status')}",
            f"- Candidate windows / shared objects / covered occurrences: {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('candidate_window_count')} / {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('shared_synthesis_object_count')} / {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('covered_occurrence_count')}",
            f"- Duplicate theta occurrences / optimistic cache signal: {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('duplicate_theta_occurrence_count')} / {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('optimistic_cache_proxy_t_reuse')}",
            f"- Object existence / all windows covered: {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('shared_object_existence_gate_passed')} / {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('all_candidate_windows_covered')}",
            f"- Replay/layout/B7-accepted object counts: {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('semantic_replay_verified_object_count')} / {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('physical_layout_assigned_object_count')} / {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('b7_ledger_accepted_object_count')}",
            f"- Occurrence-ledger removed occurrences / proxy-T reduction: {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('occurrence_ledger_removed_occurrences')} / {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('occurrence_ledger_proxy_t_reduction')}",
            f"- Cost model accepted: {report['b1']['b7_cone01_shared_theta_synthesis_object_gate'].get('cost_model_accepted')}",
            ...
            "",
            f"- Exists: {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('exists')}",
            f"- Status: {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('status')}",
            f"- Candidate windows / shared objects: {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('candidate_window_count')} / {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('shared_synthesis_object_count')}",
            f"- Layout-routed objects / occurrences: {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('layout_routed_object_count')} / {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('layout_routed_occurrence_count')}",
            f"- Logical anchors / route packets: {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('logical_anchor_object_count')} / {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('logical_route_packet_count')}",
            f"- Logical topology qubits / total hops / max hops: {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('logical_line_topology_qubit_count')} / {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('total_logical_hop_count')} / {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('max_logical_hop_count')}",
            f"- Missing routes / layout gate passed: {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('missing_route_count')} / {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('layout_routing_gate_passed')}",
            f"- Physical layout / factory model / error budget present: {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('physical_layout_claimed')} / {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('factory_amortization_model_present')} / {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('shared_error_budget_present')}",
            f"- Occurrence-ledger removed occurrences / proxy-T reduction: {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('occurrence_ledger_removed_occurrences')} / {report['b1']['b7_cone01_shared_theta_layout_routing_gate'].get('occurrence_ledger_proxy_t_reduction')}",
            ...
            "",
            f"- Exists: {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('exists')}",
            f"- Status: {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('status')}",
            f"- Candidate windows / shared objects / duplicate theta occurrences: {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('candidate_window_count')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('shared_synthesis_object_count')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('duplicate_theta_occurrence_count')}",
            f"- Baseline/shared proxy-T pressure: {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('baseline_proxy_t_pressure')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('shared_object_proxy_t_pressure')}",
            f"- Gross proxy-T delta: {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('gross_proxy_t_pressure_delta')}",
            f"- Double-counted occurrences / proxy-T: {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('double_counted_occurrence_count')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('double_counted_proxy_t_pressure')}",
            f"- Independent-baseline gate / evidence present: {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('independent_baseline_gate_passed')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('independent_baseline_present')}",
            f"- Independent physical baseline / device-calibrated baseline / refreshed B7 ledger: {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('independent_physical_baseline_present')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('device_calibrated_baseline_present')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('refreshed_b7_ledger_present')}",
            f"- Rewrite/resource/semantic/physical/B7-ledger claims: {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('rewrite_claimed')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('resource_saving_claimed')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('semantic_certificate_claimed')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('physical_resource_reduction_claimed')} / {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('b7_ledger_improvement_claimed')}",
            f"- Validation errors: {report['b1']['b7_cone01_shared_theta_independent_baseline_gate'].get('validation_error_count')}",
            "",
            "## B1/B7 cone_01 Shared-Theta Refreshed-B7-Ledger Gate",
            "",
            f"- Exists: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('exists')}",
            f"- Status: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('status')}",
            f"- Refresh attempted / CM-08 passed: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('b7_ledger_refresh_attempted')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('cm08_refreshed_b7_ledger_gate_passed')}",
            f"- B7 accepts theta sharing / cost model accepted: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('b7_ledger_accepts_theta_sharing')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('cost_model_accepted')}",
            f"- Cost-model gates passed / failed: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('cost_model_acceptance_pass_count')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('cost_model_acceptance_fail_count')}",
            f"- Occurrence removals / occurrence proxy-T reduction: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('occurrence_ledger_removed_occurrences')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('occurrence_ledger_proxy_t_reduction')}",
            f"- B7 proxy-T reduction before / after refresh: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('b7_ledger_proxy_t_reduction_before_refresh')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('b7_ledger_proxy_t_reduction_after_refresh')}",
            f"- Target / missing proxy-T reduction: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('target_proxy_t_ledger_reduction_for_gcm_h6_1_20')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('missing_proxy_t_ledger_reduction_for_gcm_h6_1_20')}",
            f"- gcm_h6 current T ledger / target max: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('gcm_h6_current_total_t_ledger')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('gcm_h6_target_max_after_t_ledger_1_20')}",
            f"- gcm_h6 min row improved: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('gcm_h6_min_row_improved')}",
            f"- Physical layout / factory schedule / device validation: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('physical_device_layout_present')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('physical_factory_schedule_present')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('device_calibrated_validation_present')}",
            f"- Rewrite/resource/semantic/physical/B7-ledger claims: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('rewrite_claimed')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('resource_saving_claimed')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('semantic_certificate_claimed')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('physical_resource_reduction_claimed')} / {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('b7_ledger_improvement_claimed')}",
            f"- Validation errors: {report['b1']['b7_cone01_shared_theta_refreshed_b7_ledger_gate'].get('validation_error_count')}",
            "",
            ...
            f"- Independent-baseline gate / gross delta: {report['b1']['b7_cone01_theta_sharing_cost_model_gate'].get('shared_theta_independent_baseline_gate_passed')} / {report['b1']['b7_cone01_theta_sharing_cost_model_gate'].get('shared_theta_independent_baseline_gross_proxy_t_delta')}",
            f"- Double-counted occurrences / proxy-T: {report['b1']['b7_cone01_theta_sharing_cost_model_gate'].get('shared_theta_double_counted_occurrence_count')} / {report['b1']['b7_cone01_theta_sharing_cost_model_gate'].get('shared_theta_double_counted_proxy_t_pressure')}",
            f"- Refreshed-B7-ledger attempt / passed: {report['b1']['b7_cone01_theta_sharing_cost_model_gate'].get('shared_theta_b7_ledger_refresh_attempted')} / {report['b1']['b7_cone01_theta_sharing_cost_model_gate'].get('shared_theta_refreshed_b7_ledger_gate_passed')}",
            f"- B7 accepts theta sharing / refreshed proxy-T reduction / gcm_h6 improved: {report['b1']['b7_cone01_theta_sharing_cost_model_gate'].get('shared_theta_b7_ledger_accepts_theta_sharing')} / {report['b1']['b7_cone01_theta_sharing_cost_model_gate'].get('shared_theta_b7_ledger_proxy_t_reduction_after_refresh')} / {report['b1']['b7_cone01_theta_sharing_cost_model_gate'].get('shared_theta_gcm_h6_min_row_improved')}",
