...
- Mean STV reduction: 1.000x
- Comparisons with factory bottleneck: 18
- Minimum logical T-count reduction: 1.000x
- Mean logical T-count reduction: 1.000x

## Comparisons

| workload | factory variant | bottleneck before | bottleneck after | STV reduction | T-count reduction | T-depth reduction |
|---|---|---|---|---:|---:|---:|
| aggregate_30_circuits | serial_factory | factory_path | factory_path | 1.000x | 1.000x | 1.173x |
| aggregate_30_circuits | balanced_factories | factory_path | factory_path | 1.000x | 1.000x | 1.173x |
| aggregate_30_circuits | throughput_heavy_factories | factory_path | factory_path | 1.000x | 1.000x | 1.173x |
| qasmbench_interaction_exact/basis_trotter_n4.qasm | serial_factory | factory_path | factory_path | 1.000x | 1.000x | 0.958x |
| qasmbench_interaction_exact/basis_trotter_n4.qasm | balanced_factories | factory_path | factory_path | 1.000x | 1.000x | 0.958x |
| qasmbench_interaction_exact/basis_trotter_n4.qasm | throughput_heavy_factories | factory_path | factory_path | 1.000x | 1.000x | 0.958x |
...
| qasmbench_medium_exact/qf21_n15.qasm | serial_factory | factory_path | factory_path | 1.000x | 1.000x | 1.632x |
| qasmbench_medium_exact/qf21_n15.qasm | balanced_factories | factory_path | factory_path | 1.000x | 1.000x | 1.632x |
| qasmbench_medium_exact/qf21_n15.qasm | throughput_heavy_factories | factory_path | factory_path | 1.000x | 1.000x | 1.632x |
