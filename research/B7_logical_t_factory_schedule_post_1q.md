# B7 Logical T-Resource Factory Schedule With B1 Post-1Q Pass v0.1

Last updated: 2026-06-13

Status: **logical_t_factory_schedule_proxy_not_physical_layout**

This reruns the same B7 logical T-factory scheduler with the B1 after-state set
to virtual-SWAP elimination plus post-virtual-SWAP 1Q resynthesis. It measures
whether the weak B1 T-resource signal propagates into factory-dominated
space-time volume.
...
- Mean STV reduction: 1.034x
- Comparisons with factory bottleneck: 18
- Minimum logical T-count reduction: 1.000x
- Mean logical T-count reduction: 1.034x

## Comparisons

| workload | factory variant | bottleneck before | bottleneck after | STV reduction | T-count reduction | T-depth reduction |
|---|---|---|---|---:|---:|---:|
| aggregate_30_circuits | serial_factory | factory_path | factory_path | 1.018x | 1.018x | 1.190x |
| aggregate_30_circuits | balanced_factories | factory_path | factory_path | 1.018x | 1.018x | 1.190x |
| aggregate_30_circuits | throughput_heavy_factories | factory_path | factory_path | 1.018x | 1.018x | 1.190x |
