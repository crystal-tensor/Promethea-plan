...
| B6 | High-temperature superconductivity search | T-B6-001 curated retrospective table plus leakage audit: 26 records / 12 families, post-2008 split, all-physics AP@10 0.89 vs random AP@10 mean 0.5346, post-split physics AP 0.9094 vs family-prior AP 0.9379 and random AP mean 0.9030; 0 validation errors; no discovery or mechanism claim. | Replace qualitative descriptors with computed structural/electronic descriptors and B5-linked observables, while expanding post-split negatives so random/family baselines cannot saturate. | Demote if computed descriptors do not beat family-prior and random baselines after expanded negative controls and family/time splits. |
...
| 3 | Keep B3 demoted unless a rescue mechanism appears; advance B5 from MPS/ALS prototype to mature variational DMRG/MPS evidence or quantum response-kernel cost accounting; advance B6 from curated leakage audit to computed structural/electronic descriptors plus B5-linked observables. |
