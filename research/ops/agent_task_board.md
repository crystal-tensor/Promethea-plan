...
| T-B2-003 | B2 | open | unassigned | Builder | Start a genuinely different B2 mechanism: non-aggressive schedule, different code family, leakage-aware circuit model, or larger-distance decoder improvement that can produce distance-5/7 Wilson target-volume reductions under noise mismatch. |
