...
cz q[0], q[3];
cz q[0], q[6];
u3(1.5707963267948966,3.1415926535897931,3.1415926535897931) q[0];
cx q[0], q[1];
cx q[0], q[2];
u3(1.5707963267948966,3.1415926535897931,3.1415926535897931) q[3];
cx q[3], q[4];
cx q[3], q[5];
u3(1.5707963267948966,3.1415926535897931,3.1415926535897931) q[6];
cx q[6], q[7];
cx q[6], q[8];
cz q[0], q[1];
cz q[0], q[2];
...
u3(1.5707963267948966,3.1415926535897931,3.1415926535897931) q[10];
u3(1.5707963267948966,3.1415926535897931,3.1415926535897931) q[3];
cx q[10], q[3];
u3(1.5707963267948966,3.1415926535897931,3.1415926535897931) q[6];
cx q[10], q[6];
